...
def browser_setup(browser)
  ...
  when 'chrome'
    Capybara.register_driver :chrome do |app|
      Selenium::WebDriver::Chrome.driver_path = 'C:/Users/Виктор/Documents/git/ruby_test_project/chromedriver.exe'
    ...
    Capybara.register_driver :firefox_driver do |app|
      ...
      Selenium::WebDriver::Firefox.driver_path = 'C:/Users/Виктор/Documents/git/ruby_test_project/geckodriver.exe'
      profile['browser.download.folderList'] = 2 # custom location
      profile['browser.download.useDownloadDir'] = true
      profile['browser.download.dir'] = 'C:/Users/Виктор/Documents/git/ruby_test_project/features/tmp'
      profile['browser.helperApps.neverAsk.saveToDisk'] = 'application/octet-stream, text/xml'
      profile['pdfjs.disabled'] = true
